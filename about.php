...
<head>
    ...
    <title>About - Your Journal Platform</title>
...
<section class="hero">
    <div class="container">
        <h1>About Our Journaling Platform</h1>
        <p>Discover the story behind the most trusted online journaling platform, designed to help you capture your
            thoughts, memories, and personal growth journey.</p>
    </div>
</section>
    ...
    <div class="container">
        <div class="about-grid">
            <div class="about-content">
                ...
                <p>Our journaling platform was born from a simple belief: everyone deserves a private space to express
                    themselves freely and authentically. Founded in 2008, we set out to create the most personalized,
                    secure, and intuitive journaling experience available online.</p>
                <p>What started as a small project by a team of writers and developers who were passionate about
                    journaling has grown into a platform trusted by millions worldwide. Our mission remains unchanged:
                    to help people capture their thoughts, process emotions, and document their lives in a safe digital
                    environment.</p>
                <p>Through consistent innovation and listening to our users, we've evolved while staying true to our
                    core principles of privacy, simplicity, and personal growth.</p>
            </div>
            <div class="about-image">
                <img src="img/Women on laptop.jpg" alt="Woman journaling on laptop" style="border-radius:20px;">
            </div>
        </div>
    </div>
</section>
...
<section class="features" id="features">
    <div class="container">
        <div class="features-header">
            ...
            <p>Our platform combines thoughtful features with a commitment to your privacy</p>
        </div>
        <div class="features-grid">
            <div class="feature-card">
                <div class="feature-icon">
                    <svg width="50px" height="50px" viewBox="0 -7.17 272.075 272.075"
                ...
                <p>Your thoughts remain private with military-grade encryption and secure access controls. Only you can
                    see your entries.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
           ...
           <g>
             <path d="M415.867,374.409c-8.827-8.827-20.562-13.686-33.044-13.686s-24.218,4.86-33.046,13.687
               ...
               c6.209,0,12.048,2.419,16.438,6.807C408.325,400.081,408.325,414.83,399.262,423.894z"/>
                ...
                <h3>Custom styles</h3>
                <p>Express yourself with customizable templates, fonts, colors, and formatting to make your journal
                    uniquely yours.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                    <svg width="50px" height="50px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g data-name="07-phone" id="_07-phone">

                            <path class="cls-1" d="M13,31H9a2,2,0,0,1-2-2V3A2,2,0,0,1,9,1H23a2,2,0,0,1,2,2V15"/>

                            <path class="cls-1" d="M20,1V3a2,2,0,0,1-2,2H14a2,2,0,0,1-2-2V1"/>

                            <path class="cls-1" d="M16,29a2,2,0,0,0,2,2h8a2,2,0,0,0,2-2V24l3,3"/>

                            <line class="cls-1" x1="28" x2="25" y1="24" y2="27"/>

                            <path class="cls-1" d="M28,21a2,2,0,0,0-2-2H18a2,2,0,0,0-2,2v5l-3-3"/>

                            <line class="cls-1" x1="16" x2="19" y1="26" y2="23"/>
                ...
                <p>Access your journal anytime, anywhere with our mobile-friendly platform that syncs across all your
                    devices.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                    <svg fill="#000000" width="50px" height="50px" viewBox="0 0 1024 1024"
                         xmlns="http://www.w3.org/2000/svg">
                ...
                <p>Never face writer's block again with our extensive library of thought-provoking journal prompts and
                    exercises.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                ...
                <h3>Rich search</h3>
                <p>Easily find specific entries with powerful search tools that help you rediscover important moments
                    and insights.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                ...
                <h3>Daily habits</h3>
                <p>Build a consistent journaling practice with reminders, streaks, and gentle accountability
                    features.</p>
            </div>
        </div>
    </div>
...
<section class="vision">
    <div class="container">
        <h2>Built for Journaling</h2>
        <p>Our platform was designed from the ground up to provide the perfect environment for self-reflection, creative
            expression, and personal growth through journaling.</p>
        <div class="vision-image">
            <img src="img/journal view.jpeg" alt="Journal interface screenshot">
        </div>
    </div>
</section>
...
<section class="platform">
    <div class="container">
        <div class="platform-header">
            <h2>With You At All Times </h2>
            <p>Your journal is always accessible whenever inspiration strikes</p>
        </div>
        <div class="platform-showcase">
            <div class="platform-image">
                <img src="img/home-img.jpeg" alt="Journal mobile app">
            </div>
            <div class="platform-features">
                <h3>Access your journal anywhere</h3>
                <ul class="platform-feature-list">
                    <li><span class="feature-check">✓</span> Seamless syncing across all devices</li>
                    <li><span class="feature-check">✓</span> Responsive design for any screen size</li>
                    <li><span class="feature-check">✓</span> Works offline with automatic updates</li>
                    <li><span class="feature-check">✓</span> Cross-plateform support</li>
                    <li><span class="feature-check">✓</span> Full-featured web application</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="privacy">
    <div class="container privacy-container">
        <h2><span><svg width="80px" height="80px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg></span> Privacy is our #1 concern
        </h2>
        <p>Even when handling deeply personal topics, your content can only be read by anyone with the password upon
            access. Private thoughts and personal memories stay locked behind 256-bit encryption and multiple security
            protocols.</p>
        <p>We've built our platform with privacy as the foundation, ensuring your journal remains your private sanctuary
...
<section class="cta">
    <div class="container">
        ...
        <p>Join millions of people who are discovering the benefits of regular journaling with our platform.</p>
